...
public class GeneratedProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.github.nekdenis.wssample.provider";
    public static final String CONTENT_URI_BASE = "content://" + AUTHORITY;

    public static final String QUERY_NOTIFY = "QUERY_NOTIFY";
    public static final String QUERY_GROUP_BY = "QUERY_GROUP_BY";

    private static final int URI_TYPE_MAPPOINT = 0;
    private static final int URI_TYPE_MAPPOINT_ID = 1;
    ...
    static {
        URI_MATCHER.addURI(AUTHORITY, MappointColumns.TABLE_NAME, URI_TYPE_MAPPOINT);
        URI_MATCHER.addURI(AUTHORITY, MappointColumns.TABLE_NAME + "/#", URI_TYPE_MAPPOINT_ID);
    }
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            case URI_TYPE_MAPPOINT:
                return TYPE_CURSOR_DIR + MappointColumns.TABLE_NAME;
            case URI_TYPE_MAPPOINT_ID:
                return TYPE_CURSOR_ITEM + MappointColumns.TABLE_NAME;
    ...
    private QueryParams getQueryParams(Uri uri, String selection, String[] projection) {
        ...
        switch (matchedId) {
            case URI_TYPE_MAPPOINT:
            case URI_TYPE_MAPPOINT_ID:
                res.table = MappointColumns.TABLE_NAME;
                res.tablesWithJoins = MappointColumns.TABLE_NAME;
                res.orderBy = MappointColumns.DEFAULT_ORDER;
                break;
